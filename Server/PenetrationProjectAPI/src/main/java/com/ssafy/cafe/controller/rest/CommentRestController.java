...
public class CommentRestController {
	...
	@GetMapping("/all")
	@ApiOperation(value = "전체 comment의 목록을 반환한다.", response = List.class)
	public List<Comment> getAllCommentst() {
		return cService.getAllComments();
	}
	
	@GetMapping("/{productId}")
	@ApiOperation(value = "특정 productId의 comment 목록을 반환한다.", response = List.class)
	public List<Comment> getCommentsById(@PathVariable Integer productId) {
